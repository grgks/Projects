Αυτό το project αναπτύχθηκε για εκπαιδευτικούς σκοπούς, με στόχο την εξάσκηση και την κατανόηση βασικών εννοιών προγραμματισμού, όπως η διαχείριση αρχείων, η χρήση πινάκων και η δημιουργία συνδυασμών.
